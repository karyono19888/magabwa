	...
	<body class="font-[Poppins] pb-[72px]">
		...
		<nav id="Category" class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]">
			@foreach ($category as $categories)
				<a href="{{route('front.category',$categories->slug)}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18]">
					<div class="w-6 h-6 flex shrink-0">
						<img src="{{Storage::url($categories->icon)}}" alt="icon" />
					</div>
